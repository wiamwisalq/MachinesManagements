                        ...
                        <div class="col-sm-6">
                           ...
                           <input id="idh" type="hidden" value="">
                          	<form class="user">
                                 ...
                                 <div class="form-group">
                                     <input type="text" class="form-control form-control-user"
                                         id="libelle" placeholder="Description">
                                 </div>
                                 <div class="p-3"></div>
                                 ...
                                 <a id="cl" class="btn btn-primary btn-user btn-block" >
                                     Clear
                                 </a>
                             </form>
                    </div>
                    ...
                    <div class="card shadow mb-4" style="background-color: #FCF1EE;">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered"  width="100%" cellspacing="0" id="t">
                                    <thead> 
                                        <tr>
                                            <th align="center">ID</th>
                                            <th align="center">Code</th>
                                            <th align="center">Liblle</th>
