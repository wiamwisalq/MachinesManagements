                          	...
                          	<form class="user" id="frima">
                                 ...
                                 <div class="form-group">
                                     <input type="date" class="form-control form-control-user"
                                         id="dateA" placeholder="Date D'achat">
                                 </div>
                                 <div class="form-group">
                                     <input type="text" class="form-control form-control-user"
                                 ...
                                 <div class="form-group">
                                 <select  id="marques" class="form-control-user btn btn-primary btn-user btn-block" style="background-color: #DBB7B4;">								    								    
								 </select>
								 </div>
                                 <div class="p-3"></div>
                                 ...
                                 <a id="mod" class="btn btn-primary btn-user btn-block" >
                                     Modiffier
                                 </a>
                                 <a id="cle" class="btn btn-primary btn-user btn-block" >
                                     Clear
                                 </a>
                             </form>
                    </div>
